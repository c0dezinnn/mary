...
exports.run = async (client, message, args) => {
  ...
  if (!["700157765053841438","700157765053841438"].includes(message.author.id)) { //Apenas usuarios que forem adicionados poderão utiliar o comando
    return message.channel.send(`ERROR:404 comando não encontrado!`);
  }
