...
.setDescription("**❌ Você não possue a permissão de `Gerenciar chats` para executar este comando**")
.setColor("#ff0000")
...
let channel =
    ...
    try {
      ...
      if (channel.id === a) {
        return message.channel.send({embed: {
          description: "**❌ Este chat ja foi setado**",
         color: "#ff0000"
        }}); 
        ...
        client.guilds.cache
          ...
          .send("**🛑 | Mod Log Setado neste chat!**");
