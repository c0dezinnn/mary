    ...
    try {
        ...
        if (!message.guild.me.hasPermission("MANAGE_GUILD")) {
            embed.setAuthor("Erro")
                 .setDescription("<:IconAnnouncementChannel:755451226686226480> » Não tenho acesso aos convites do servidor, verifique minhas permissões!");
        ...
        invites.forEach(invite => usedInvites.push([`${invite.inviter.tag} › ${invite.uses}\n`]));
          ...
          .setTitle(`<a:737438827253071903:750392392246493285> » Rank de Convites`)
