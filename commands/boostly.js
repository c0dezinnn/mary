...
if(!['767868534645719050'].includes(message.author.id)) return message.channel.send("Você não tem permissão.")
exports.run = async (client, message, args) => {
  const timestamp = 86400000;
  const amount = Math.floor(Math.random() * (5000 - 1000) + 500);
...
.setTitle(` Parabéns! Hoje você ganhou \`${amount}\` gbcoins.\n> `);
    message.reply(b);
