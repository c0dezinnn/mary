...
exports.run = async (bot, message, args) => {
    ...
    if (author !== null && timeout - (Date.now() - author) > 0) {
        ...
        let replies = ['Programador','Construtor','Agricultor','Garoto(a) de Programa','Garçom','Mecanico','Cozinheiro','Programador da mary',
         'mary',             'Vendedor','Barqueiro','Youtuber','Padeiro']
